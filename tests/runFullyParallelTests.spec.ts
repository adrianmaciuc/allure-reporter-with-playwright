...
test.describe('Run all tests in full PARALLEL mode', () => {

  test.beforeAll('beforeAll PARALLEL mode', () => {
    console.log("I am executed in beforeAll hook from PARALLEL mode")
  });
  test.beforeEach('beforeEach PARALLEL mode', () => {
    console.log("I am executed in beforeEach hook from PARALLEL mode")
  });
